...
export const navRow =
  'group flex h-[28px] w-full items-center gap-8 rounded-lg pl-10 pr-[9px] text-[13px] font-medium leading-none transition-colors'
...
export const menuItem =
  'flex w-full items-center gap-8 rounded-xs px-8 py-[6px] text-left text-[13px] font-normal text-ink transition-colors hover:bg-hover focus-visible:bg-hover'

export const menuItemWorkspace =
  'relative flex h-[32px] w-full items-center rounded-lg px-[8px] pr-[12px] text-left text-[13px] font-normal leading-[19.5px] text-ink transition-colors hover:bg-[lch(96_0_282)] focus-visible:bg-[lch(96_0_282)]'
