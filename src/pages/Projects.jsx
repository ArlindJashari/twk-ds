    ...
    <PageFrame toolbar={<ProjectsToolbar />}>
      <div className="flex flex-1 flex-col items-center justify-center px-24 py-48 text-center">
        ...
        <div className="mt-76 flex items-center gap-8">
          <button type="button" aria-label="Create new project" className="flex h-[28px] items-center gap-6 rounded-full bg-accent px-10 text-[12px] font-medium text-onaccent outline-none transition-colors hover:bg-accent-hover focus-visible:ring-2 focus-visible:ring-accent-soft">
